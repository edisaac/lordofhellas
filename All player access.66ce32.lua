...
adminOnlyButton = false
selectColour = {0.3, 1, 0.3}
textColour = {0.5, 0.5, 0.5}
allColour = {'Red','Teal','Yellow','Green','Blue','Purple'}
dRoll=0
function onLoad()
    local buttonParams = {}
...
function shufflePlayers(object, colour)
    ...
    printToAll('(#' .. dRoll .. ') ' .."Shuffle Players: ".. Player[colour].steam_name .. " initiated shuffling.", textColour)

    local ranColours = {}

    --INSERT THE COLOURS

    for _, v in pairs(allColour) do
