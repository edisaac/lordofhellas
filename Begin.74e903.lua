...
ATLAS_TILE=Global.getVar("ATLAS_TILE")
...
function setLastGod()
  ...
  elseif  god.guid == ATLAS_TILE then setAtlas()     
  else
    setHephestos()
  end
end
...
function setAtlas()
  printToAll("ATLAS_TILE")
  local apple = getObjectFromGUID(APPLE_GUI)
  local deckPos = apple.getPosition()
  for i = 1, 14 do
      local temp = apple.clone()
      temp.setPosition(deckPos)
